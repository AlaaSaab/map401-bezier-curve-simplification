...
typedef struct Cellule_Liste_Contours {
   Liste_Point contour;  
   struct Cellule_Liste_Contours *suiv;  
...
Liste_Contours concatener_liste_Contours(Liste_Contours L, Liste_Contours L1);

Liste_Point approx_bezier2(Tableau_Point contour, int j1, int j2);